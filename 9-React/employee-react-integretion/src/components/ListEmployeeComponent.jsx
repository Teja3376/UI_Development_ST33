...
const ListEmployeeComponent = () => {
  const [employees, setEmployees] = useState([]); // State hook to store employees
  ...
  const viewEmployee = (id) => {
    navigate(`/view-employee/${id}`); // Use navigate to go to the view page
  };

  const editEmployee = (id) => {
    navigate(`/add-employee/${id}`); // Use navigate to go to the edit page
  };

  const addEmployee = () => {
    navigate('/add-employee/_add'); // Use navigate to go to the add page
  };
